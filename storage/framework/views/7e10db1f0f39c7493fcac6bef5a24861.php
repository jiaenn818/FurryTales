    ...
    <?php $__env->startSection('content'); ?>
        <div class="dashboard-container">
            ...
            <div class="dashboard-header">
                <h2>Welcome back, <?php echo e(auth()->user()->name ?? 'Admin'); ?> 👋</h2>
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        <h3><?php echo e($totalOrders ?? 0); ?></h3>
                        <p>Total Purchases</p>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-info">
                        <h3><?php echo e($appointmentCount ?? 0); ?></h3>
                    ...
                    <table class="simple-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recentAppointments ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($appointment->CustomerName ?? 'N/A'); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($appointment->AppointmentDateTime)->format('d M Y')); ?></td>
                                    <td>
                                        <?php
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\finalyear\resources\views/admin/adminDashboard.blade.php ENDPATH**/ ?>