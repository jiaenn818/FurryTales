...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <h2>Report</h2>
        <div>
            Today is <?php echo e($currentDateTime->format('d M Y, h:i A')); ?>

        </div>

            <form method="GET" action="<?php echo e(route('admin.reports')); ?>" id="filterForm">
                <div class="filter-container">
                <input type="text" id="purchaseDateRange" placeholder="Select month..." autocomplete="off">
                <input type="hidden" name="start_date" id="startDate" value="<?php echo e($startDate ?? ''); ?>">
                <input type="hidden" name="end_date" id="endDate" value="<?php echo e($endDate ?? ''); ?>">
        ...
        <div class="parent">
            <div class="div1">
                ...
                <h2>RM <?php echo e(number_format($latestMonthSales['amount'], 2)); ?></h2>

                <small style="color: <?php echo e($latestMonthSales['isIncrease'] ? 'green' : 'red'); ?>;">
                    Compared to last month:
                    <?php echo e($latestMonthSales['difference'] >= 0 ? '+' : '-'); ?>

                    RM <?php echo e(number_format(abs($latestMonthSales['difference']), 2)); ?>
            ...
            <div class="div2">
                ...
                <h2><?php echo e($latestMonthSales['orders']); ?> Orders</h2>

                <small style="color: <?php echo e($latestMonthSales['order_isIncrease'] ? 'green' : 'red'); ?>;">
                    Compared to last month:
                    <?php echo e($latestMonthSales['order_difference'] >= 0 ? '+' : '-'); ?>

                    <?php echo e(abs($latestMonthSales['order_difference'])); ?>

                </small>
            </div>

            <div class="div3">
                <?php if($statusReport->isEmpty()): ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fp = flatpickr(dateRangeInput, {
                ...
                defaultDate: "<?php echo e(isset($startDate) ? \Carbon\Carbon::parse($startDate)->format('Y-m') : ''); ?>",
            ...
            // SALES CHART
            const salesLabels = <?php echo json_encode($monthlySales->pluck('month')->values(), 15, 512) ?>;
            const salesData = <?php echo json_encode($monthlySales->pluck('total_revenue')->values(), 15, 512) ?>;
            ...
            // STATUS CHART
            const statusLabels = <?php echo json_encode($statusReport->pluck('Status'), 15, 512) ?>;
            const statusData = <?php echo json_encode($statusReport->pluck('total_orders'), 15, 512) ?>;
            ...
            // BREED CHART
            const breedLabels = <?php echo json_encode($topBreeds->pluck('Breed'), 15, 512) ?>;
            const breedData = <?php echo json_encode($topBreeds->pluck('total_sold'), 15, 512) ?>;
            ...
            // ACCESSORY CHART
            const accessoryLabels = <?php echo json_encode($topAccessories->pluck('AccessoryName'), 15, 512) ?>;
            const accessoryData = <?php echo json_encode($topAccessories->pluck('total_sold'), 15, 512) ?>;
            ...
            // OUTLET CHART
            const outletStateLabels = <?php echo json_encode($topOutlets->pluck('State'), 15, 512) ?>;
            const outletSalesData = <?php echo json_encode($topOutlets->pluck('total_sales'), 15, 512) ?>;
            const outletOrderCounts = <?php echo json_encode($topOutlets->pluck('order_count'), 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\finalyear\resources\views/admin/report/report.blade.php ENDPATH**/ ?>