...
<script>
    ...
    async function askGemini() {
        ...
        try {
           const response = await fetch('<?php echo e(route("help.ask")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/help.blade.php ENDPATH**/ ?>