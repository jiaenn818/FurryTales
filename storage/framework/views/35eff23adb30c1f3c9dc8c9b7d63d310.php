...
<div class="orders-show-page">
    <div class="container">
        ...
        <!-- Back Button -->
        <a href="<?php echo e(route('client.orders.index')); ?>" class="orders-back-button">
        ...
        <div class="receipt-actions" style="margin: 20px 0; display: flex; gap: 10px;">
            <button onclick="window.open('<?php echo e(route('client.order.print-receipt', $order->PurchaseID)); ?>', '_blank')" class="btn btn-primary">
                🖨️ Print Receipt
            </button>
                        
            <a href="<?php echo e(route('client.order.download-receipt', $order->PurchaseID)); ?>" class="btn btn-success">
                📥 Download Receipt
            </a>
</div>
                                        ...
                                        <div class="order-item-selections" style="margin-top: 0.5rem; font-size: 0.85rem; color: #4b5563;">
                                            ...
                                            <?php if($item->OutletID): ?>
                                                <div class="item-outlet" style="margin-top: 0.25rem; font-size: 0.8rem; color: #f7941d; font-weight: 600;">
                                                    <span>📍 Store: <?php echo e($item->outlet->City); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/Client/orders/show.blade.php ENDPATH**/ ?>