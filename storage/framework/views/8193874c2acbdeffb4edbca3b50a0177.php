              ...
              <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    ...
                    $image = $isPet
                        ...
                        : ($product->Image ?? 'image/default-pet.png');
                ...
                <div class="cart-item">
                    ...
                    <div class="cart-col info">
                        ...
                        <?php if($item->OutletID): ?>
                            <div class="outlet">📍 <?php echo e($item->outlet->State); ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="cart-col remove">
                        <form action="<?php echo e(route('cart.remove', $item->CartItemID)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <?php if($cartItems->isEmpty()): ?>
                    <div class="cart-empty">
                        ...
                        <a href="<?php echo e(route('pets.index')); ?>">Browse Pets</a>
                        <a href="<?php echo e(route('accessories.index')); ?>">Browse Accessories</a>
                    </div>
                <?php endif; ?>
            </div>

            
            <div class="cart-logistics-container">
                
                <div class="cart-address-section">
                    <div class="cart-delivery-section" style="margin-top: 0;">
                        <h3 style="margin-bottom: 1rem;">Delivery Method</h3>
                ...
                <div class="cart-address-section">
                    <div class="cart-form-section">
                        <label style="margin-bottom: 0.75rem; display: block;">Contact Information</label>
                        <div class="cart-form-grid">
                            ...
                            <input type="text" placeholder="Phone Number" id="contact-phone" value="<?php echo e(Auth::user()->phoneNo); ?>" class="cart-form-input">
                        </div>
                    </div>
                </div>
                ...
                <div class="cart-address-section">
                    ...
                    <div id="pickup-fields" class="cart-form-section hidden">
                        <label style="margin-bottom: 0.75rem; display: block;">Pickup Details</label>
                        <div class="cart-form-grid">
                            <input type="text" id="pickup-date" readonly class="cart-form-input" placeholder="Pickup Date" style="background: var(--color-brand-soft);">
                            <select id="pickup-time" class="cart-form-input">
                    ...
                    <div id="delivery-fields" class="cart-form-section">
                        <label style="margin-bottom: 0.75rem; display: block;">Delivery Address</label>
                        <textarea placeholder="Address (Street, Unit, etc.)" id="delivery-address" rows="3" class="cart-form-textarea" style="margin-bottom: 1rem;"><?php echo e(Auth::user()->customer->address ?? ''); ?></textarea>
                        
                        <div class="cart-form-grid" style="grid-template-columns: 1fr 1fr;">
                            <input type="text" placeholder="Postcode" id="delivery-postcode" class="cart-form-input" style="margin-bottom: 0;">
                            <input type="text" placeholder="State" id="delivery-state" class="cart-form-input" style="margin-bottom: 0;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cart-summary">
            <div class="cart-summary-panel">
                ...
                <div class="cart-summary-details">
                    ...
                    <div class="cart-summary-item" style="display: flex; justify-content: space-between; margin-top: 1rem;">
                        <span>Subtotal:</span>
                        <span id="summary-price" style="font-weight: 600;">RM 0.00</span>
                    </div>
                    <div id="discount-row" class="cart-summary-item hidden" style="display: flex; justify-content: space-between; margin-top: 0.5rem;">
                        <span>Discount (<span id="discount-code"></span>):</span>
                        <span id="discount-amount" class="discount-text">-RM 0.00</span>
                    </div>
                    <div style="margin-top: 1rem; border-top: 2px solid var(--color-brand-light); padding-top: 1rem; display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="cart-promo-section" style="margin-top: 1.5rem; background: var(--color-brand-soft); border-color: var(--color-brand-light);">
                    <label for="promo-code-input" class="cart-promo-label">Promo Code</label>
                    <div style="display: flex; gap: 0.5rem;">
                        <input type="text" id="promo-code-input" class="cart-form-input" placeholder="Enter code" style="margin-bottom: 0; flex: 1;">
                        <button type="button" id="apply-promo-btn" class="cart-apply-btn">
                            Apply
                        </button>
                    </div>
                    <p id="promo-message" class="promo-message" style="display: none;"></p>
                    <button type="button" id="view-vouchers-btn" class="view-vouchers-btn" style="background: white;">
                        View Available Vouchers
                    </button>
                </div>

                <button id="checkout-btn" class="cart-checkout-button" style="margin-top: 1.25rem;">
                    Check Out
                </button>
                
                <form id="checkout-form" action="<?php echo e(route('payment.checkout')); ?>" method="POST" class="hidden">
                    <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.cart-variant-select').forEach(select => {
        select.addEventListener('change', function() {
            ...
            fetch('<?php echo e(route("cart.updateVariant")); ?>', {
                method: 'POST',
                headers: {
    ...
    if (applyBtn) {
        applyBtn.addEventListener('click', function(e) {
            ...
            fetch('<?php echo e(route("cart.applyVoucher")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
function updateSummary() {
    ...
    if (finalEl) {
        const total = Math.max(0, subtotal - (window.appliedDiscount || 0));
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/cart.blade.php ENDPATH**/ ?>