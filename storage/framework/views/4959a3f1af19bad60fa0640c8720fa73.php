...
<div class="profile-page">
    <div class="container">
        <div class="profile-container">
            ...
            <form action="<?php echo e(route('password.update')); ?>" method="POST" class="profile-form">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="profile-form-actions profile-form-actions-center">
                    ...
                    <div class="profile-form-cancel-wrapper">
                        <a href="<?php echo e(route('profile.view')); ?>" class="profile-form-cancel-link">
                            Cancel
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/profile/change.blade.php ENDPATH**/ ?>