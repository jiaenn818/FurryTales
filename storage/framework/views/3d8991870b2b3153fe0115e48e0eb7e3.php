        ...
        <div class="pet-show-details">
            <div class="pet-show-details-card">
                ...
                <div class="pet-show-actions">
                    <a href="<?php echo e(route('appointments.create', $pet->PetID)); ?>" class="pet-show-action-button pet-show-action-appointment">
                        Make Appointment
                    </a>

                    <form id="addToCartForm" action="<?php echo e(route('cart.add', $pet->PetID)); ?>" method="POST" class="pet-show-action-form">
                        <?php echo csrf_field(); ?>
    ...
    <div class="pet-show-modal-wrapper">
        ...
        <div class="pet-show-modal-content">
            ...
            <div id="cartModalOptions" class="pet-show-modal-options">
                <a href="<?php echo e(route('cart.view')); ?>" class="pet-show-modal-button pet-show-modal-button-primary">
                    Go to Cart
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/pets/show.blade.php ENDPATH**/ ?>