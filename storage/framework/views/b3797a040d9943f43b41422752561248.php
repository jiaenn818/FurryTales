                                            ...
                                            stockHtml += `
                                                <div class="outlet-card">
                                                    ...
                                                    <label for="outlet_${vo.OutletID}" class="outlet-card-label">
                                                        <span class="outlet-name">${vo.outlet ? vo.outlet.State : vo.OutletID} Outlet</span>
                                        ...
                                        stockHtml += `
                                            <div class="outlet-card">
                                                ...
                                                <label for="outlet_${outlet.OutletID}" class="outlet-card-label">
                                                    <span class="outlet-name">${outlet.State} Outlet</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/accessory/show.blade.php ENDPATH**/ ?>