...
<div class="orders-page">
    ...
    <form method="GET" action="<?php echo e(route('client.orders.index')); ?>" class="filter-form">
                        ...
                        <div class="order-card">
                            ...
                            <div class="order-card-content">
                                ...
                                <div class="order-actions">
                                    <a href="<?php echo e(route('client.orders.show', $order->PurchaseID)); ?>" class="order-view-button">
                                        View Details
                                        <span>→</span>
                                    </a>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\finalyear\resources\views/Client/orders/index.blade.php ENDPATH**/ ?>