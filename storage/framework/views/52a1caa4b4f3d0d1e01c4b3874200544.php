...
<div class="reviews-page container">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="order-review-card">
            ...
            <?php if($reviewed): ?>
                <div class="review-details">
                    <div class="reviewer-info">
                        <img src="<?php echo e($reviewed->purchase->customer->profile_photo ? asset('image/' . $reviewed->purchase->customer->profile_photo) : asset('image/profile.png')); ?>" class="reviewer-photo">
                        <span class="reviewer-name"><?php echo e($reviewed->purchase->customer->user->name); ?></span>
            ...
            <?php elseif(in_array($order->Status, ['Picked Up', 'Delivered'])): ?>
                <form action="<?php echo e(route('reviews.store')); ?>" method="POST" class="review-form">
                    <?php echo csrf_field(); ?>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="review-card">
            <div class="reviewer-info">
                <img src="<?php echo e($review->purchase->customer->profile_photo ? asset('image/' . $review->purchase->customer->profile_photo) : asset('image/profile.png')); ?>" class="reviewer-photo">
                <span class="reviewer-name"><?php echo e($review->purchase->customer->user->name); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/reviews.blade.php ENDPATH**/ ?>