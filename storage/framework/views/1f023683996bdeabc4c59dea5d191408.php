            ...
            <div class="profile-content">
                ...
                <div class="profile-header">
                    <div class="profile-image-wrapper">
                        ...
                        <?php if(isset($customerData)): ?>
                            <form action="<?php echo e(route('profile.uploadPhoto')); ?>" method="POST" enctype="multipart/form-data" class="profile-photo-upload">
                                <?php echo csrf_field(); ?>
                    ...
                    <?php if(isset($customerData)): ?>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="profile-edit-button">
                            Edit Profile
                        </a>
                    <?php endif; ?>
                </div>
                ...
                <?php if(isset($customerData) && $customerData): ?>
                    ...
                    <div class="profile-password-section">
                        ...
                        <a href="<?php echo e(route('password.change')); ?>" class="profile-password-link">
                            Change Password
                        </a>
                    </div>
                ...
                <?php else: ?>
                    <div class="profile-empty">
                        ...
                        <a href="<?php echo e(route('login.page')); ?>" class="profile-login-button">
                            Login Now
                        </a>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/profile/view.blade.php ENDPATH**/ ?>