...
<body style="font-family: Arial, sans-serif; background:#f9fafb; padding:20px;">
    ...
    ">
        ...
        <p>Hello <?php echo e($purchase->CustomerID); ?>,</p>
        ...
        ">
            ...
            <h3 style="margin:8px 0 0; color:#a95c68;">
                <?php echo e(\Carbon\Carbon::parse($purchase->DeliveredDate)->format('d M Y, h:i A')); ?>
...
</html><?php /**PATH C:\Users\User\finalyear\resources\views/emails/purchase_delivered.blade.php ENDPATH**/ ?>