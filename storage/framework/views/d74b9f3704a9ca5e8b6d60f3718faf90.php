    ...
    <div class="container">
        <div class="appointments-index-container">
            ...
            <div class="appointments-empty">
                ...
                <a href="<?php echo e(route('pets.index')); ?>" class="appointments-empty-button">
                    Browse Pets
                </a>
            </div>
            <?php else: ?>
                    ...
                    <div class="appointment-card-content">
                        ...
                        <div class="appointment-details">
                            ...
                            <div class="appointment-actions">
                                <a href="<?php echo e(route('pets.show', $appointment->pet->PetID)); ?>" 
                                   class="appointment-action-button appointment-action-button-view">
                                    View Pet
                                </a>

                                <?php if($appointment->Status === 'Upcoming'): ?>
                                <form action="<?php echo e(route('appointments.cancel', $appointment->AppointmentID)); ?>" method="POST" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/appointments/index.blade.php ENDPATH**/ ?>