...
<body class="auth-page">
    ...
    <div class="auth-container forget-container">
        <div class="auth-inner">
            ...
            <form action="<?php echo e(route('client.forget.sendOTP')); ?>" method="POST" class="auth-form">
                <?php echo csrf_field(); ?>
                <div class="forget-input-wrapper">
                    <input type="text" name="customerID" placeholder="Enter Customer ID" required 
                           value="<?php echo e(old('customerID') ?? session('customerID_sent')); ?>"
                           class="forget-input">
            ...
            <?php if(session('reset_otp') && !session('otp_verified')): ?>
            <form action="<?php echo e(route('client.forget.verifyOTP')); ?>" method="POST" class="auth-form">
                <?php echo csrf_field(); ?>
            ...
            <?php if(session('otp_verified') && session('customer_id')): ?>
            <form action="<?php echo e(route('client.forget.resetPassword')); ?>" method="POST" class="auth-form">
                <?php echo csrf_field(); ?>
                <div class="auth-input-group">
            ...
            <div class="auth-messages">
                ...
                <div class="auth-alert auth-alert-success">
                    <?php echo e($successMessage); ?> Redirecting in <span id="countdown">2</span> seconds.
                </div>
                <script>
                    let seconds = 2;
            ...
            <div class="forget-links">
                <a href="<?php echo e(route('client.login.page')); ?>">
                    <span>←</span> Return to Login
                </a>
                <?php if(session()->has('reset_otp')): ?>
                    <span class="divider">|</span>
                    <form action="<?php echo e(route('client.forget.clearSession')); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
                        <button type="submit">
                            Start Over
                        </button>
...
</html><?php /**PATH C:\Users\User\finalyear\resources\views/client/forget.blade.php ENDPATH**/ ?>