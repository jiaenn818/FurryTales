...
<body class="auth-page">
    ...
    <div class="auth-container">
        <div class="auth-inner">
            ...
            <form action="<?php echo e(route('client.login.submit')); ?>" method="POST" class="auth-form">
                <?php echo csrf_field(); ?>

                <div class="auth-input-group">
                    <input type="text" name="userid" placeholder="User ID" required class="auth-input" value="<?php echo e(old('userid', Cookie::get('remember_custid'))); ?>">
                </div>
                ...
                <div class="auth-links">
                    <a href="<?php echo e(route('client.forget.page')); ?>" class="auth-link">
                        Forget Password?
                    </a>
                    <a href="<?php echo e(route('client.register.page')); ?>" class="auth-link">
