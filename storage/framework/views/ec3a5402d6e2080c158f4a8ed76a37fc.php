        ...
        <div class="profile-container">
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="profile-form">
                ...
                <div class="profile-form-actions">
                    ...
                    <a href="<?php echo e(route('profile.view')); ?>" class="profile-form-cancel">
                        Cancel
                    </a>
                </div>
            </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/profile/edit.blade.php ENDPATH**/ ?>