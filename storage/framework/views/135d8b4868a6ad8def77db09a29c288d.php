                                    ...
                                    <select name="OutletID">
                                        ...
                                        <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($outlet->OutletID); ?>">
                                                <?php echo e($outlet->OutletID); ?> - <?php echo e($outlet->State); ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-type="<?php echo e($user->customer ? 'customer' : ($user->staff ? 'staff' : ($user->rider ? 'rider' : 'normal'))); ?>"
                                data-userid="<?php echo e(strtolower($user->userID)); ?>" data-name="<?php echo e(strtolower($user->name)); ?>"
                                data-email="<?php echo e(strtolower($user->email)); ?>">
                                <td  style="text-align: center">
                                    <?php echo e($user->staff->StaffID ?? ($user->rider->riderID ?? ($user->customer->customerID ?? $user->userID))); ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(!$user->customer && !$user->staff && !$user->rider): ?>
                                        <span class="badge normal">User</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($user->name); ?></td>
                                <td>
                                    <i class="fas fa-envelope"></i> &nbsp;<?php echo e($user->email); ?> <br>
                                    <i class="fas fa-phone"></i> &nbsp;<?php echo e($user->phoneNo); ?>

                                </td>
                                <td>
                                    <?php if($user->customer): ?>
                                        <div>
                                            <strong>Customer ID:</strong> <?php echo e($user->customer->customerID); ?><br>
                                            <strong>Address:</strong> <?php echo e($user->customer->address ?? '—'); ?><br>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($user->staff): ?>
                                        <div>
                                            <strong>Staff ID:</strong> <?php echo e($user->staff->StaffID); ?><br>
                                            <strong>Role:</strong> <?php echo e($user->staff->Role); ?><br>
                                            <strong>Outlet:</strong>
                                            <?php if($user->staff->outlet): ?>
                                                <?php echo e($user->staff->OutletID); ?> - <?php echo e($user->staff->outlet->State); ?>

                                            <?php else: ?>
                                                <?php echo e($user->staff->OutletID ?? '—'); ?>
                                    ...
                                    <?php if($user->rider): ?>
                                        <div>
                                            <strong>Rider ID:</strong> <?php echo e($user->rider->riderID); ?><br>
                                            <strong>Postcode:</strong> <?php echo e($user->rider->postCode); ?>
                                ...
                                <td>
                                    <form action="<?php echo e(route('admin.users.updateStatus', $user->userID)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <select name="status" onchange="this.form.submit()">
                                            <option value="active" <?php echo e($user->status === 'active' ? 'selected' : ''); ?>>
                                                Active ●</option>
                                            <option value="ban" <?php echo e($user->status === 'ban' ? 'selected' : ''); ?>>Ban ●
                                            </option>
                                        </select>
                                    </form>
                                    <strong>Created At :</strong><?php echo e($user->created_at ? $user->created_at->format('d M Y') : '-'); ?>

                                </td>
                                <td>
                                    <form action="<?php echo e(route('admin.users.destroy', $user->userID)); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMPP\htdocs\finalyear\resources\views/admin/viewAllUsers.blade.php ENDPATH**/ ?>