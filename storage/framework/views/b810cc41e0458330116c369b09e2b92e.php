    ...
    <div class="container">
        ...
        <aside class="pets-sidebar">
            <div class="pets-filter-panel">
                <form id="filterForm" action="<?php echo e(route('client.pets.index')); ?>" method="GET">
                        ...
                        <div id="petsSearchHistoryBody" class="pets-search-history-body">
                            <?php $__currentLoopData = $searchHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="pets-search-card" id="search-history-<?php echo e($history->SearchHistoryID); ?>">
                                    <a href="<?php echo e(route('client.pets.index', ['search' => $history->keyword])); ?>"
                    ...
                    <div class="pets-category-section">
                        ...
                        <h4 class="pets-category-header">
                            <a href="<?php echo e(route('client.pets.index', $allPetsParams)); ?>" 
                               class="pets-category-title <?php echo e($isActiveAll ? 'active' : ''); ?>">
                               All Pets
                            </a>
                        </h4>
                    </div>

                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeObj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $type = $typeObj->Type;
                        ?>
                        <div class="pets-category-section">
                            ...
                            <h4 class="pets-category-header">
                                <a href="<?php echo e(route('client.pets.index', $newParams)); ?>" 
                            ...
                            <?php if($isActiveType): ?>
                                <div class="pets-breed-select-wrapper" style="margin-top: 10px;">
                                    <select name="breed" onchange="this.form.submit()" class="pets-select">
                                        <option value="">All <?php echo e($type); ?> Breeds</option>
                                        <?php if(isset($breeds[$type])): ?>
                                            <?php $__currentLoopData = $breeds[$type]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breed): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($breed->Breed); ?>"
                                                    <?php echo e(request('breed') === $breed->Breed ? 'selected' : ''); ?>>
                    ...
                    <div class="pets-category-section">
                        ...
                        <select name="outlet" onchange="this.form.submit()" class="pets-select">
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($outlet->City); ?>"
                                    <?php echo e(request('outlet') === $outlet->City ? 'selected' : ''); ?>>
                                    <?php echo e($outlet->City); ?>
        ...
        <main class="pets-main">
                    ...
                    <?php $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pets-card">
                            <div class="pets-card-image">
                                <a href="<?php echo e($pet->isSold() ? '#' : route('client.pets.show', $pet->PetID)); ?>"
                            ...
                            <div class="pets-card-content">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('client.pets.show', $pet->PetID)); ?>" class="pets-card-button">View Details</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
                ...
                <div class="pets-empty">
                    ...
                    <a href="<?php echo e(route('client.pets.index')); ?>">Clear all filters</a>
                </div>
            <?php endif; ?>
...
function displayResults(list) {
   ...
   function deleteSearchHistory(id) {
    ...
    function clearAllSearchHistory() {
        ...
        fetch('<?php echo e(route("client.search-history.clear")); ?>', {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                'Accept': 'application/json'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/Client/pets/index.blade.php ENDPATH**/ ?>