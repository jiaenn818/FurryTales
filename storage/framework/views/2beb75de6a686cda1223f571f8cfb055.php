    ...
    <div class="container">
        ...
        <aside class="pets-sidebar">
            <div class="pets-filter-panel">
                <form id="filterForm" action="<?php echo e(route('accessories.index')); ?>" method="GET">
                    ...
                    <div class="pets-category-section">
                        ...
                        <ul class="pets-breed-list">
                            <li class="pets-breed-item">
                                <a href="<?php echo e(route('accessories.index', request()->except(['category', 'page']))); ?>"
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="pets-breed-item">
                                    <a href="<?php echo e(route('accessories.index', array_merge(request()->query(), ['category' => $category->Category]))); ?>"
                    ...
                    <div class="pets-category-section">
                        ...
                        <ul class="pets-breed-list">
                            <li class="pets-breed-item">
                                <a href="<?php echo e(route('accessories.index', request()->except(['outlet', 'page']))); ?>"
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="pets-breed-item">
                                    <a href="<?php echo e(route('accessories.index', array_merge(request()->query(), ['outlet' => $outlet->OutletID]))); ?>"
                                       class="<?php echo e(request('outlet') === $outlet->OutletID ? 'active' : ''); ?>">
                                       <?php echo e($outlet->OutletID); ?>
        ...
        <main class="pets-main">
                    ...
                    <?php $__currentLoopData = $accessories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accessory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pets-card">
                            <div class="pets-card-image">
                                <a href="#">
                                    <img src="<?php echo e(asset($accessory->Image ?: 'image/default-pet.png')); ?>"
                            ...
                            <div class="pets-card-content">
                                ...
                                <p class="pets-card-price"><span class="pets-price-label">From </span>RM <?php echo e(number_format($accessory->Price, 2)); ?></p>

                                <a href="<?php echo e(route('accessories.show', $accessory->AccessoryID)); ?>" class="pets-card-button">View Details</a>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <?php else: ?>
                <div class="pets-empty">
                    ...
                    <a href="<?php echo e(route('accessories.index')); ?>">Clear all filters</a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/accessories.blade.php ENDPATH**/ ?>