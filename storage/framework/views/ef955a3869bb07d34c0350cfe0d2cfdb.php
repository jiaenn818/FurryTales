    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-text">
                ...
                <a href="<?php echo e(route('pets.index')); ?>" class="hero-button">
                    Browse Pets
                </a>
            </div>
            <!-- Image Hero -->
...
<section class="featured-section">
    <div class="container">
        <div class="featured-header">
            <h3>New Arrivals</h3>
            <a href="<?php echo e(route('pets.index')); ?>">View All Pets &rarr;</a>
        </div>
        ...
        <div class="featured-grid">
            ...
            <div class="featured-card">
                ...
                <div class="featured-card-content">
                    <h4>Golden Bundle</h4>
                    <a href="<?php echo e(route('pets.index')); ?>" class="featured-card-button">
                        Take Me Home!
                    </a>
                </div>
            </div>
            ...
            <div class="featured-card">
                <div class="featured-card-image">
                    <img src="<?php echo e(asset('image/cat1.avif')); ?>" alt="cat">
                </div>
                <div class="featured-card-content">
                    <h4>Royal Feline</h4>
                    <a href="<?php echo e(route('pets.index')); ?>" class="featured-card-button">
            ...
            <div class="featured-card">
                <div class="featured-card-image">
                    <img src="<?php echo e(asset('image/dog2.webp')); ?>" alt="dog">
                </div>
                <div class="featured-card-content">
                    <h4>Playful Pup</h4>
                    <a href="<?php echo e(route('pets.index')); ?>" class="featured-card-button">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/home.blade.php ENDPATH**/ ?>