                    ...
                    <div class="pets-category-section">
                        ...
                        <select name="outlet" onchange="this.form.submit()" class="pets-select">
                            ...
                            <?php $__currentLoopData = $outlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($outlet->OutletID); ?>" <?php echo e(request('outlet') === $outlet->OutletID ? 'selected' : ''); ?>>
                            ...
                            <div class="pets-card-image">
                                <a href="<?php echo e($pet->isSold() ? '#' : route('pets.show', $pet->PetID)); ?>"
                                   class="<?php echo e($pet->isSold() ? 'cursor-default' : ''); ?>">
                                    <img src="<?php echo e(asset($pet->Photo1 ?: 'image/default-pet.png')); ?>"
                                ...
                                <?php if(isset($recommendedPets) && $recommendedPets->pluck('PetID')->contains($pet->PetID)): ?>
                                    <span class="pets-card-recommend-badge">RECOMMEND</span>
                                <?php endif; ?>
    ...
    if (list.length === 0) {
        container.innerHTML = `
            <div class="no-results-message">
                <p>No similar pets found. Try a clearer photo!</p>
            </div>
                            ...
                            card.innerHTML = `
                                <div class="pets-card-image">
                                    <a href="${isSold ? '#' : '/pets/' + pet.PetID}" class="${isSold ? 'cursor-default' : ''}">
                                        <img src="${pet.Photo1 || '/image/default-pet.png'}" alt="${pet.PetName}" class="${isSold ? 'pets-card-image-sold' : ''}">
                                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\finalyear\resources\views/pets.blade.php ENDPATH**/ ?>