        ...
        <div class="card">
            ...
            <div class="form">
                ...
                <select name="healthStatus" required>
                    ...
                    <option value="Excellent" <?php echo e($pet->HealthStatus === 'Excellent' ? 'selected' : ''); ?>>Excellent</option>
                    <option value="Good" <?php echo e($pet->HealthStatus === 'Good' ? 'selected' : ''); ?>>Good</option>
                    <option value="Fair" <?php echo e($pet->HealthStatus === 'Fair' ? 'selected' : ''); ?>>Fair</option>
                </select>

                <select name="vaccinationStatus" required>
                    <option disabled selected>Vaccination Status</option>
                    <option value="Up-to-date" <?php echo e($pet->VaccinationStatus === 'Up-to-date' ? 'selected' : ''); ?>>Up-to-date</option>
                    <option value="Due Soon" <?php echo e($pet->VaccinationStatus === 'Due Soon' ? 'selected' : ''); ?>>Due Soon</option>
                    <option value="Overdue" <?php echo e($pet->VaccinationStatus === 'Overdue' ? 'selected' : ''); ?>>Overdue</option>
                    <option value="Not-vaccinated" <?php echo e($pet->VaccinationStatus === 'Not-vaccinated' ? 'selected' : ''); ?>>Not-vaccinated</option>
                    <option value="Partial" <?php echo e($pet->VaccinationStatus === 'Partial' ? 'selected' : ''); ?>>Partial</option>
                </select>
...
</html><?php /**PATH C:\Users\User\finalyear\resources\views/admin/pets/petEdit.blade.php ENDPATH**/ ?>