    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-text">
                ...
                <a href="{{ route('client.pets.index') }}" class="hero-button">
                    Browse Pets
                </a>
            </div>
            <!-- Image Hero -->
            <div class="hero-image">
                <img src="{{ asset('image/home1.jpg') }}" alt="Pets">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="founder-card">
            <div class="founder-image-wrapper">
                <img src="{{ asset('image/founder.jpg') }}" alt="Founder">
            </div>
...
<section class="featured-section">
    <div class="container">
        <div class="featured-header">
            <h3>New Arrivals</h3>
            <a href="{{ route('client.pets.index') }}">View All Pets &rarr;</a>
        </div>
        ...
        <div class="featured-grid">
            ...
            <div class="featured-card">
                <div class="featured-card-image">
                    <img src="{{ asset('image/dog1.jpeg') }}" alt="dog">
                </div>
                <div class="featured-card-content">
                    <h4>Pets</h4>
                    <a href="{{ route('client.pets.index') }}" class="featured-card-button">
                        Take Me Home!
                    </a>
                </div>
            </div>
            ...
            <div class="featured-card">
                <div class="featured-card-image">
                    <img src="{{ asset('image/appointment.jpg') }}" alt="cat">
                </div>
                <div class="featured-card-content">
                    <h4>Viewing Appointments</h4>
                    <a href="{{ route('client.appointments.index') }}" class="featured-card-button">
                        Book Now!
                    </a>
                </div>
            </div>
            ...
            <div class="featured-card">
                <div class="featured-card-image">
                    <img src="{{ asset('image/accessory.webp') }}" alt="dog">
                </div>
                <div class="featured-card-content">
                    <h4>Pets Accessories</h4>
                    <a href="{{ route('client.accessories.index') }}" class="featured-card-button">
                        Buy One!
                    </a>
                </div>
            </div>
...
<script>
    const loggedInUserID = "{{ Auth::check() && Auth::user()->customer ? Auth::user()->customer->customerID : '' }}";
</script>
@endsection
