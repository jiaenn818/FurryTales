...
@section('content')
    <main class="admin-content">
        ...
        <form method="GET" action="{{ route('admin.pets.index') }}" class="filters-container">
            ...
            <a href="{{ route('admin.pets.index') }}">Clear</a>
        </form>
                        ...
                        @foreach ($pets as $pet)
                            ...
                            <tr data-type="{{ strtolower($pet->Type) }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.pets.edit', $pet->PetID) }}" class="btn btn-warning btn-sm">
                                        Edit
                                    </a>

                                    <form action="{{ route('admin.pets.destroy', $pet->PetID) }}" method="POST"
                                ...
                                <div class="popup-overlay" id="petPopup{{ $pet->PetID }}">
                                    <div class="popup-box">
                                        ...
                                        <p><strong>Outlet:</strong>
                                            {{ $outlet ? $outlet->OutletID . ' - ' . $outlet->City . '  (' . $outlet->State . ')' : 'N/A' }}
                                        </p>
                                        <p><strong>Supplier:</strong>
                                            {{ $supplier ? $supplier->SupplierID . ' - ' . $supplier->SupplierName : 'N/A' }}
                                        </p>
            ...
            if (addImageBtn) {
                ...
                addImageBtn.addEventListener('click', function() {
                    if (imageCount < maxImages) {
                        ...
                        setTimeout(() => {
                            document.getElementById(`extraImage${newIndex}`)
                        .click(); // Use backticks here too
                        }, 100);
                    }
                });
            }
