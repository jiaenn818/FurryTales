        ...
        <div class="card">
            ...
            <div class="image-upload">
                <label for="imageInput">
                    <img src="{{ asset('image/default-pet.png') }}" id="preview">
                    <p>Upload Image</p>
                </label>
            ...
            <div class="form">
                ...
                <input type="text" value="{{ $nextPetID }}" readonly disabled>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            imageInput.addEventListener('change', async () => {
                ...
                try {
                    const res = await fetch("{{ route('admin.pets.detectBreed') }}", {
                        method: 'POST',
                        headers: {
            ...
            function createImageInput(index) {
                ...
                img.src = "{{ asset('image/default-pet.png') }}";
